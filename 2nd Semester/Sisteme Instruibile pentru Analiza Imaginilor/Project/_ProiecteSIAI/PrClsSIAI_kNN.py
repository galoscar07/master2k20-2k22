...
# In[] 
# import pandas as pd
# dsXy = pd.read_csv("datasets/College_Data",index_col=0)
# print(dsXy.head())

# X = dsXy.drop('Private',axis=1)
# y = dsXy['Private']
...
# incercati mai mult valori pentru n_neighbors = 1, 3, 5 - si in functie de datasets
